import { Parser, ComponentDoc, FileParser, ParserOptions } from 'react-docgen-typescript';
...
function findReactComponents(sourceFile: ts.SourceFile, typeChecker: ts.TypeChecker) {
